...
export default function All_code_plate() {
  ...
  { 
    ...
    fetched_codeall.length>0 && fetched_codeall.map((single_code)=>{
      ...
      return <Code_plate key={single_code.title} single_codes={single_code} code={single_code.hlo} title={single_code.title} description={single_code.description} delete_code={deleteallnotes} _id={single_code._id} handle_edit={handle_edit}/>
    })
  }
  </div>
    </>
